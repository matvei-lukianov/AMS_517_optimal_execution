"""
Risk-Averse Deep RL for Optimal Trade Execution — v2
...
Changes vs v1:
  ...
  - Stronger terminal penalty (1.5%) + per-step urgency penalty
...
T_STEPS          = 10
N_ACTIONS        = 11
TERMINAL_PENALTY = 0.015   # 1.5% — was 0.3%, forces agent to sell before deadline
URGENCY_SCALE    = 3.0     # bps per unit of (inv/Q) * (1/steps_remaining)
GAMMA_PERM       = 0.00002
...
class OptiverEnv:
    ...
    def step(self, q: int):
        ...
        # Urgency penalty: holding inventory near deadline is costly
        # Proportional to inv_frac * (1/steps_remaining) — grows exponentially near T
...
print(f"Continuous state | Parallel training | Terminal penalty=1.5%")
print("=" * 72)
